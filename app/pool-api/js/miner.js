function MinerApi () {
  this._get_miner_global_stats = function (miner_address) {
     $.ajax({
          type: "GET",
  ...
  this._update_miner_global_stats = function () {
  ...
  this.miner_address = "";
  this.miner_address_type = "";
  
  this.get_miner_address = function () {
    if (this.miner_address === "") {
  ...
  this.set_miner_address = function (address) {
  ...
  this.refresh_five_seconds = function () {
    this.miner_address = this.get_miner_address();
    if (this.miner_address !== "") {
    }
  };
  
  this.refresh_thirty_seconds = function () {
    this.miner_address = this.get_miner_address();
    if (this.miner_address !== "") {
    }
  };
  
  this.refresh_sixty_seconds = function () {
    this.miner_address = this.get_miner_address();
    if (this.miner_address !== "") {
    }
  };
  
  this.is_valid_xmr_address = function (address) {
  ...
  this.is_valid_btc_address = function (address) {
    if (typeof(address) === 'string') {
      address = address.split('.');
    } else {
      return false;
